...
//   );
//   let datumProcessor: common.DatumStoring<util.TSQLRow> | undefined = undefined;
//   const onEnd = () => {
//     if (datumProcessor) {
//       datumProcessor.end();
...
//           ({ storing: datumProcessor, promise } = datumProcessorFactory(
//             {
//               tableID,
//               tableMD,
//               additionalColumns: [
...
//   if (errors.length > 0) {
//     throw new util.MultipleErrors(errors);
//   }
